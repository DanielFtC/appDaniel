...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    activar: function activar(curso) {
      var _this = this;

      var x = document.getElementById(curso.id);
      ...
      if (x.checked == true) {
        ...
        console.log(params);
        var app = this;
        axios.put("/api/administrador/almacen/cursos/".concat(curso.id), params).then(function (res) {
          app.$Progress.start();
          toast.fire({
            icon: 'success',
        ...
        console.log(_params);
        var app = this;
        axios.put("/api/administrador/almacen/cursos/".concat(curso.id), _params).then(function (res) {
          app.$Progress.start();
          toast.fire({
            icon: 'success',
                  ...
                  _c(
                    ...
                    _vm._l(_vm.cursos, function(curso, index) {
                      return _c("tr", { key: index }, [
                        ...
                        _c("td", [
                          _vm._v(
                            _vm._s(_vm._f("tolowercase")(curso.CursosNombre))
                          )
                        ]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(curso.precio) + " PEN")]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(curso.created_at))]),
                        _vm._v(" "),
                        _c("td", [_vm._v(_vm._s(curso.updated_at))]),
                        _vm._v(" "),
                        _c("td", [
                          _c("input", {
                            staticClass: "activ",
                            attrs: { type: "checkbox", id: curso.id },
                            domProps: { checked: curso.estado == "activo" },
                            on: {
                              click: function($event) {
                                return _vm.activar(curso)
                              }
                            }
                          })
                        ])
